...
# opts.add_argument(f"--user-data-dir=/Users/devil/Desktop/webprofiles/test")
opts.add_argument(f"--user-data-dir=/Users/devil/Desktop/webprofiles")
opts.add_argument(f"--profile-directory=dev")
